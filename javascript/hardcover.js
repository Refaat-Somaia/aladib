let activeIndex = 1;
let notebooks = [
  "../assets/images/hardcover/2.png",
  "../assets/images/hardcover/1.png",
  "../assets/images/hardcover/3.png",
  "../assets/images/hardcover/4.png",
  "../assets/images/hardcover/5.png",
  "../assets/images/hardcover/6.png",
  "../assets/images/hardcover/7.png",
  "../assets/images/hardcover/8.png",
  "../assets/images/hardcover/9.png",
  "../assets/images/hardcover/10.png",
  "../assets/images/hardcover/12.png",
];
...
function previous() {
  if (activeIndex + 1 == notebooks.length) activeIndex = 0;
...
function next() {
  if (activeIndex - 1 == -1) activeIndex = notebooks.length - 1;
  else activeIndex = activeIndex - 1;
